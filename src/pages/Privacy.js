    ...
    return (
      <div className="privacy">
        <Accordion
          ...
          content={`<p>hudson-essentials may collect the following information from users of our site: first name, last name, street address, area and city, phone and contact numbers, e-mail address, GPS location (mobile site) (collectively, "Personally Identifiable Information" or "PII").</p>

<p>In addition, hudson-essentials may collect information regarding hudson-essentials account holders' past hudson-essentials orders, favorite restaurants, customer service inquiries, service/restaurant reviews and certain social networking preferences (e.g. pages you "Like" or "Recommend").</p>

<p>hudson-essentials also uses web analytics software to track and analyze traffic on the site in connection with hudson-essentials advertising and promotion of hudson-essentials services. hudson-essentials may publish these statistics or share them with third parties without including PII.</p>

<p>Non-Personally Identifiable Information (or "Non-PII") is aggregated information, demographic information and any other information that does not reveal your specific identity. We and our third party service providers may collect Non-PII from you, including your MAC address, your computer type, screen resolution, OS version, Internet browser and demographic data, for example your location, gender and date of birth and we may aggregate PII in a manner such that the end-product does not personally identify you or any other user of the Site, for example, by using PII to calculate the percentage of our users who have a particular telephone area code. We and our third party service providers may also use cookies, pixel tags, web beacons, and other similar technologies to better serve you with more tailored information and facilitate your ongoing use of our Site. If you do not want information collected through the use of cookies, there is a simple procedure in most browsers that allows you to decline the use of cookies. To learn more about cookies, please visit http://www.allaboutcookies.org/.</p>
...
IP Addresses are the Internet Protocol addresses of the computers that you are using. Your IP Address is automatically assigned to the computer that you are using by your Internet Service Provider (ISP). This number is identified and logged automatically in our server log files whenever users visit the Site, along with the time(s) of such visit(s) and the page(s) that were visited. Collecting IP Addresses is standard practice on the Internet and is done automatically by many websites.`}
        ...
        <Accordion
          ...
          content={`<p>hudson-essentials uses PII to create users' hudson-essentials accounts, to communicate with users about hudson-essentials services, to offer users additional services, promotions and special offers and to charge for purchases made through hudson-essentials. Users may affirmatively opt-out of receiving promotional communications from hudson-essentials by visiting www.hudson-essentials.com. Personal account page and providing hudson-essentials with their e-mail address via the opt-out link. hudson-essentials may also use PII to enforce hudson-essentials terms of use and service.</p>

<p>hudson-essentials uses cookies to remember users on the site and to enhance users' experience on the site. For example, when users with hudson-essentials accounts return to the site, cookies identify those users and allow the site to provide certain user-specific information such as hudson-essentials login information, choice of website language and country selection in addition to any other information we might collect in the future. hudson-essentials does not sell the information it collects to third parties. hudson-essentials shares collected PII to third-party vendors and service providers with whom hudson-essentials works to provide application programming interfaces ("APIs") and other functions for the site in connection with the delivery of hudson-essentials services. In addition, hudson-essentials shares users' hudson-essentials order content, special order instructions, first and last name, street address and telephone number with restaurants where users' orders are placed to the extent necessary to process those orders. hudson-essentials may also disclose PII to third parties such as attorneys, collection agencies, tribunals or law enforcement authorities pursuant to valid requests in connection with alleged violations of hudson-essentials terms of use and service or other alleged contract violations, infringement or similar harm to persons or property.</p>

<p>User generated content posted through the site such as service/restaurant reviews and certain social networking preferences (e.g. pages you "Like" or "Recommend") may be viewed by the general public. Accordingly, hudson-essentials cannot ensure the privacy of any PII included in such user generated content.</p>

<p>Non-Personally Identifiable Information. Because Non-PII does not personally identify you, we may use such information for any purpose. In addition, we reserve the right to share such Non PII, which does not personally identify you, with our affiliates and with other third parties, for any purpose. In some instances, we may combine Non-PII with PII (such as combining your name with your geographical location). If we do combine any Non-PII with PII, the combined information will be treated by us as PII hereunder as long as it is so combined.</p>
...
`}
        ...
        />
        <Accordion
          title="Do We Disclose Your Personal Information?
"
          content={`We may disclose your information to our staff and to third parties involved in the delivery of your order, and the analysis and support of your use of the website. We may disclose your information if necessary to protect our legal rights, if the information relates to actual or threatened harmful conduct, or we have good faith belief that such action is necessary to (1) conform to the requirements of law or comply with governmental orders, court orders, or legal process served on us or (2) to protect and defend our property or other rights, the users of the website or the public. This includes exchanging information with other companies and organizations for fraud protection and credit risk protection.
`}
        />
        <Accordion
          title="How Is Personally Identifiable Information Disclosed?"
          content={`<p>We may disclose PII:</p>

<p>To our third party service providers who provide services such as website hosting, data analysis, payment processing, order fulfillment, infrastructure provision, IT services, customer service, e-mail delivery services, credit card processing and other similar services to enable them to provide services.</p>

<p>As required to fulfill your purchase (e.g., to our restaurant partners to enable them to fulfill your order).</p>

<p>To identify you to any person to whom you send messages regarding Site-related content through the Site.</p>

<p>To third parties sponsors of Promotions (irrespective of whether such Promotions are hosted by us), or otherwise in accordance with the rules applicable to such Promotion. You should carefully review the rules, if any, of each Promotion in which you participate, as they may contain additional important information about a sponsor's or other third parties’ use of your PII. To the extent that the terms and conditions of such rules concerning the treatment of your PII conflict with this Privacy Policy, the terms and conditions of such rules shall control.</p>

<p>to an affiliate or other third party in the event of any reorganization, merger, sale, joint venture, assignment, transfer or other disposition of all or any portion of our business, assets or stock (including without limitation in connection with any bankruptcy or similar proceedings).</p>
...
`}
        ...
        <Accordion
          title="Security"
          content={`We use reasonable organizational, technical and administrative measures to protect PII under our control. Unfortunately, no data transmission over the Internet or data storage system can be guaranteed to be 100% secure. Please do not send us sensitive information through email. If you have reason to believe that your interaction with us is no longer secure (for example, if you feel that the security of any account you might have with us has been compromised), you must immediately notify us of the problem by contacting us in accordance with the "Contacting Us" section below (note that if you choose to notify us via physical mail, this will delay the time it takes for us to respond to the problem).
`}
        />
        <Accordion
          title="Third parties"
          content={`This Privacy Policy does not address, and we are not responsible for, the privacy, information or other practices of any third parties, including without limitation any of our affiliates and any third party operating any site to which this site contains a link. The inclusion of a link on the site does not imply endorsement of the linked site by us or by our affiliates.`}
        />
        <Accordion
          title="Information about Services We Offer"
          content={`It is very important to us that we provide you with the highest level of service. In order to help us do this, from time to time we may send you details of products, services, discounts, promotions and campaigns, which we think, may be of interest to you. We may send you marketing communications with your consent. If at any time you do not wish to receive these details and wish to unsubscribe from marketing communications, contact us via e-mail or log onto your account to change your relevant settings from my account link on the user main page.`}
        />
        <Accordion
          title="Privacy Policy amendment"
          content={`hudson-essentials may change this Privacy Policy at any time by publishing the new version on the website.
`}
        />
        <Accordion
          title="Verifying, updating and amending personal information hudson-essentials.com"
          content={`<p>Members</p>

<p>You can update your personal information at any time by logging-in to your membership account and accessing "My Account", where you can update your personal information mentioned in "Account Info" and "Saved Address".
</p>
...
Users who order as guests cannot view or change their details on the website once an order has been submitted. Any changes which affect the fulfillment of an order should be communicated directly to the applicable restaurant.`}
        ...
        <Accordion
          title="Contact"
          content={`<p>All comments, queries and requests relating to our use of your information are welcomed and should be addressed to hudson-essentials Middle East FZ-L.L.C</p>

<p>For questions or concerns relating to our privacy policy, we can be contacted by email at customercare.xxx@foodessential.com or at:</p>
